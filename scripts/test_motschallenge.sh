...
do
	echo ${vid}
	python Structured_MOTS/structured_mots_main.py config_test_motschallenge ${vid}

done

#cd Structured_MOTS/external/mots_tools
#datadir="../../../data/MOTS_Challenge/val/"
#opdir="../../../output/MOTS_Challenge/val/tracking/detectron2_x152/losses_tracklambda/test/epoch24/"
#python mots_eval/eval.py ${opdir}Instances_txt/ ${datadir}instances_txt/ mots_eval/val_MOTSChallenge.seqmap
