...
args = dict(
    ...
    n=5,
    cuda=True,
    data_dir="data/MOTChallenge/2DMOT2015/",
    dataset="train", #train, test, or val
    use_optical_flow=True,
    optical_flow_path="data/MOTChallenge/2DMOT2015/train/",
    ...
    outf='output/2DMOT2015/train/tracking/withoptflow',
    det_dir="data/MOTChallenge/MOT_other_dets/2DMOT2015_MPN",  # doesn't matter if use_given_detections is false
    mot_method="",  # FRCNN, SDP or DPM
