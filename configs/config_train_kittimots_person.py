...
args = dict(
    ...
    outf='output/KITTI_MOTS/train/tracking/detectron2_x152_person',
    det_dir="output/KITTI_MOTS/train/detections/detectron2_x152", # doesn't matter if use_given_detections is false
