...
args = dict(
    ...
    optical_flow_path="data/MOT17/test/",
    ...
    outf='output/MOT17/test/tracking/FRCNN_withoptflow',
    det_dir="data/MOT17/",  # doesn't matter if use_given_detections is false
    mot_method="DPM",  # FRCNN, SDP or DPM
